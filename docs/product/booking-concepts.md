...
| **Preferred Scheduling Context** | An optional local date and complete time window interpreted in an explicit IANA timezone. | It expresses preference only; it does not reserve capacity or schedule an appointment. |
