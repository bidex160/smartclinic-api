...
describe('Dashboard summary authorization (e2e)', () => {
  ...
  beforeAll(async () => {
    const providerSummary = { offers: { new: 1 }, appointments: { today: 2, upcoming: 3 }, healthChecks: { inProgress: 4, completed: 5 }, referrals: { availablePoints: 10, reservedPoints: 0, currentLevel: null, nextLevel: { code: 'LEVEL_1', name: 'Level 1', ordinal: 1 }, nextLevelRequirements: [], highestConfiguredLevelReached: false, qualifiedPatients: 1, qualifiedClinics: 0, qualifiedLaboratories: 0, qualifiedPharmacies: 0 } };
    const adminSummary = { bookings: { awaitingFunding: 1, pendingProviderMatch: 2, scheduled: 3, inProgress: 4, completed: 5, needsAttention: 6 }, matching: { activeOffers: 7 }, providers: { pendingReview: 8, active: 9 }, referrals: { registered: 10, qualified: 4, level1Achieved: 1, levels: [{ code: 'LEVEL_1', name: 'Level 1', ordinal: 1, achieved: 1 }], pointsIssued: 220 }, withdrawals: { requested: 3, processing: 2, paid: 5, failed: 1, pointsReserved: 900 } };
