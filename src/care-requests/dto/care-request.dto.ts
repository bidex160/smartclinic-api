...
import {
  CARE_REQUEST_REFERENCE_EXAMPLE,
  CARE_REQUEST_REFERENCE_PATTERN,
...
export class CreateCareRequestDto {
  ...
  city?: string | null;
  @ApiPropertyOptional({
    enum: CareDeliveryMode,
    default: CareDeliveryMode.IN_PERSON,
  })
  @IsOptional()
  @IsEnum(CareDeliveryMode)
...
export class CareRequestListQueryDto {
  @ApiPropertyOptional({ enum: CareRequestStatus })
  @IsOptional()
...
export class CareRequestReferenceParamsDto {
  @ApiProperty({ example: CARE_REQUEST_REFERENCE_EXAMPLE })
  @Matches(CARE_REQUEST_REFERENCE_PATTERN)
  reference!: string;
}
...
export class CareRequestAppointmentSummaryDto {
  ...
  @ApiPropertyOptional({
    type: CareRequestAppointmentLocationSummaryDto,
    nullable: true,
  })
  location!: CareRequestAppointmentLocationSummaryDto | null;
}
