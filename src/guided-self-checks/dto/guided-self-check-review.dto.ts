...
export class CompleteGuidedSelfCheckReviewDto{@IsEnum(GuidedSelfCheckReviewDecision)decision!:GuidedSelfCheckReviewDecision;@IsOptional()@IsString()@MaxLength(5000)reviewerNotes?:string;@IsOptional()@IsBoolean()contactRequired?:boolean;}
