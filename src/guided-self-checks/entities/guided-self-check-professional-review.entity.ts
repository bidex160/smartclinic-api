...
import { GuidedSelfCheckContactStatus,GuidedSelfCheckReviewDecision,GuidedSelfCheckReviewModel,GuidedSelfCheckReviewOrigin,GuidedSelfCheckReviewPriority,GuidedSelfCheckReviewStatus } from '../enums/guided-self-check-review.enum';
...
export class GuidedSelfCheckProfessionalReview {
 ...
 @Column({name:'review_model',type:'enum',enum:GuidedSelfCheckReviewModel,enumName:'guided_self_check_review_model_enum',default:GuidedSelfCheckReviewModel.INTERNAL_URGENT}) reviewModel!:GuidedSelfCheckReviewModel;
