import { IsEnum, IsLatitude, IsLongitude, IsOptional, IsString, Matches, MaxLength } from 'class-validator';import { AssistedMatchContact } from '../entities/assisted-match-request.entity';
export class CreateAssistedMatchDto {
 ...
 @IsOptional()@IsString()@MaxLength(120)city?:string; @IsOptional()@IsString()@MaxLength(30)postalCode?:string; @IsOptional()@IsLatitude()latitude?:number; @IsOptional()@IsLongitude()longitude?:number;
