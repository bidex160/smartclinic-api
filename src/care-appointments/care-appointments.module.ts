...
import { MeCareAppointmentsController, ProviderCareAppointmentsController } from './care-appointments.controller';

@Module({ imports: [AuthModule, ProvidersModule, TypeOrmModule.forFeature([CareAppointment, CareAppointmentStatusHistory, CareRequest, CareRequestStatusHistory, Patient, Provider, ProviderCareService, ProviderLocation])], controllers: [ProviderCareAppointmentsController, MeCareAppointmentsController], providers: [CareAppointmentsService], exports: [CareAppointmentsService] })
