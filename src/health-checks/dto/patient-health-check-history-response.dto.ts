...
class PatientHealthCheckParticipantDto { @ApiProperty() patientReference!: string; @ApiProperty() firstName!: string; @ApiProperty() lastName!: string; @ApiProperty() displayName!: string; }
...
export class PatientHealthCheckHistoryItemDto {
  ...
  @ApiProperty({ type: PatientHealthCheckParticipantDto }) participant!: PatientHealthCheckParticipantDto;
