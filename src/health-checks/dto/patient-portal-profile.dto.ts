...
class PatientPortalPatientDto { @ApiProperty() patientReference!: string; @ApiProperty() givenName!: string; @ApiProperty() familyName!: string; @ApiPropertyOptional({ nullable: true }) phone!: string | null; }
