...
export class FulfillmentUnitDto {
  @ApiProperty()
  @Matches(PROVIDER_SERVICE_UNIT_REFERENCE_PATTERN)
  providerServiceUnitReference!: string;
}
export class FulfillmentReferenceParamsDto {
  @Matches(CLINICAL_ORDER_FULFILLMENT_REFERENCE_PATTERN) reference!: string;
}
...
export class FulfillmentDirectoryQueryDto extends FulfillmentListQueryDto {
  @ApiPropertyOptional({ enum: ClinicalOrderType })
  @IsOptional()
