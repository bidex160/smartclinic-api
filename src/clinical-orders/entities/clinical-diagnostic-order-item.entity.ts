...
export class ClinicalDiagnosticOrderItem {
 ...
 @Column({name:'result_text',type:'text',nullable:true}) resultText!:string|null;
 @Column({name:'result_value',type:'varchar',length:120,nullable:true}) resultValue!:string|null;
 @Column({name:'result_unit',type:'varchar',length:80,nullable:true}) resultUnit!:string|null;
 @Column({name:'reference_range',type:'varchar',length:160,nullable:true}) referenceRange!:string|null;
 @Column({name:'result_flag',type:'varchar',length:40,nullable:true}) resultFlag!:string|null;
