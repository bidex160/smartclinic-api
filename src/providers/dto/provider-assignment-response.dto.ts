...
export class ProviderAssignmentResponseDto {
  ...
  @ApiProperty({ enum: ProviderAssignmentStatus })
...
export class MatchingResultResponseDto {
  ...
  @ApiPropertyOptional({ type: ProviderAssignmentResponseDto, nullable: true })
  assignment!: ProviderAssignmentResponseDto | null;
}
