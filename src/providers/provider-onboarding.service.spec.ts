...
describe('ProviderOnboardingService', () => {
  ...
  let providerRows: any[], userRows: any[], credentialRows: any[], providers: any, users: any, credentials: any, context: any, readiness: any, subject: ProviderOnboardingService;
  beforeEach(() => {
    ...
    subject = new ProviderOnboardingService(providers, users, credentials, context, readiness);
  });
