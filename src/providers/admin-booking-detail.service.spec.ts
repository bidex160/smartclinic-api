...
const booking = (changes = {}) => ({ id: 'booking-id', bookingReference: 'SC-2026-ABCDEF123456', status: BookingStatus.PENDING_PROVIDER_MATCH, createdAt: new Date('2026-08-01T00:00:00Z'), updatedAt: new Date('2026-08-02T00:00:00Z'), healthCheckPackage: { code: 'ESSENTIAL', name: 'Essential' }, fulfilmentMode: { code: 'HOME_VISIT', name: 'Home visit' }, participant: { givenName: 'Ada', familyName: 'Okafor', dateOfBirth: '1990-01-01', phone: 'private' }, contact: { givenName: 'Chidi', familyName: 'Okafor', email: 'chidi@example.test', phone: '+2348000000000' }, booker: null, preferredDate: '2026-09-01', preferredTimeWindowStart: '09:00', preferredTimeWindowEnd: '10:00', preferredTimezone: 'Africa/Lagos', preferredLocationNote: 'Ikeja area', quotedAmount: '12500.00', currency: 'NGN', ...changes });
