...
describe('AdminDashboardService', () => {
  it('returns authoritative aggregate booking, assignment, encounter, and provider counts', async () => {
    ...
    const referrals = { adminMetrics: jest.fn().mockResolvedValue({ registered: 20, qualified: 8, level1Achieved: 2, pointsIssued: 900 }), adminWithdrawalMetrics: jest.fn().mockResolvedValue({ requested: 3, processing: 2, paid: 7, failed: 1, pointsReserved: 500 }) };
