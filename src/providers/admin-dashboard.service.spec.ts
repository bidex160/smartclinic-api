...
describe('AdminDashboardService', () => {
  it('returns authoritative aggregate booking, assignment, encounter, and provider counts', async () => {
    ...
    const referralMetrics = { registered: 20, qualified: 8, level1Achieved: 2, levels: [{ code: 'LEVEL_1', name: 'Level 1', ordinal: 1, achieved: 2 }, { code: 'LEVEL_2', name: 'Level 2', ordinal: 2, achieved: 1 }], pointsIssued: 900 };
    const referrals = { adminMetrics: jest.fn().mockResolvedValue(referralMetrics), adminWithdrawalMetrics: jest.fn().mockResolvedValue({ requested: 3, processing: 2, paid: 7, failed: 1, pointsReserved: 500 }) };
