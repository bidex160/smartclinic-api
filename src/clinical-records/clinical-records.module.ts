...
import {
  MeClinicalRecordsController,
  ProviderClinicalRecordsController,
...
import {
  MeClinicalRecordAccessController,
  ProviderClinicalRecordAccessRequestsController,
  ProviderSharedClinicalRecordsController,
  ProviderSharedHealthPassportsController,
} from "./clinical-record-access.controller";
...
} from "./clinical-record-attachments.controller";
...
@Module({
  ...
  providers: [
    ...
    ClinicalRecordAccessService,
  ],
  exports: [ClinicalRecordsService, ClinicalRecordAttachmentsService],
})
